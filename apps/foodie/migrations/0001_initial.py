# Generated by Django 2.1 on 2018-08-19 06:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='producto',
            name='idPro',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='foodie.Restaurante'),
        ),
        migrations.AddField(
            model_name='pedido',
            name='idPed',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='foodie.Producto'),
        ),
    ]
